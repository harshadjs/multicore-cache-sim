...
$(TOOLS): %$(PINTOOL_SUFFIX) : %.o
	${LINKER} $(PIN_LDFLAGS) $(LINK_DEBUG) -osimulator.so directory.o dlist.o hash_table.o pintool.o simulator.o ${PIN_LPATHS} $(PIN_LIBS) $(DBG)
test:
	g++ -Wall -Werror -g dlist.c simulator.c directory.c pintool.c hash_table.c -o test
clean:
	rm -f *.o
	rm -f simulator test
